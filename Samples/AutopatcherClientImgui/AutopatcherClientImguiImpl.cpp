...
#include "AutopatcherClientImguiImpl.h"
...
public:
	...
	AutopatcherClientImguiImpl *autopatcherClient;

} transferCallback;

//AutopatcherClientImguiImpl::AutopatcherClientImguiImpl()
//{
//	autopatcherClient=0;
//	fileListTransfer=0;
//	packetizedTCP=0;
...
//	Shutdown();
//}
//void AutopatcherClientImguiImpl::Init(const char *_pathToThisExe, GPtr<FxDelegate> pDelegate, GPtr<GFxMovieView> pMovie)
//{
...
//
//}*/
//void AutopatcherClientImguiImpl::Update(void)
//{
//	RakNet::Packet *p;
//
...
//	}
//}
//void AutopatcherClientImguiImpl::Shutdown(void)
//{
...
//	packetizedTCP=0;
//}
//const char* AutopatcherClientImguiImpl::Connect(const char *ip, unsigned short port)
//{
...
//}
//void AutopatcherClientImguiImpl::PressedPatch(const FxDelegateArgs& pparams)
//{
//	AutopatcherClientImguiImpl* prt = (AutopatcherClientImguiImpl*)pparams.GetHandler();
...
//	}
//}
//void AutopatcherClientImguiImpl::OpenSite(const FxDelegateArgs& pparams)
//{
//	AutopatcherClientImguiImpl* prt = (AutopatcherClientImguiImpl*)pparams.GetHandler();
...
//	}
//}
//void AutopatcherClientImguiImpl::PressedConnect(const FxDelegateArgs& pparams)
//{
//	AutopatcherClientImguiImpl* prt = (AutopatcherClientImguiImpl*)pparams.GetHandler();
//	const char *result = prt->Connect(pparams[0].GetString(), atoi(pparams[1].GetString()));
//}
//void AutopatcherClientImguiImpl::PressedOKBtn(const FxDelegateArgs& pparams)
//{
//	AutopatcherClientImguiImpl* prt = (AutopatcherClientImguiImpl*)pparams.GetHandler();
...
//	prt->GotoMainMenu();
//}
//void AutopatcherClientImguiImpl::UpdateConnectResult( bool isConnected )
//{
//	FxResponseArgs<1> args;
...
//}
//
//void AutopatcherClientImguiImpl::Accept(CallbackProcessor* cbreg)
//{
//	cbreg->Process( "PressedOKBtn", &AutopatcherClientImguiImpl::PressedOKBtn );
