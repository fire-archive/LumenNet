...
class CCRakNetSlidingWindow
{
	...
	void OnAck(CCTimeType curTime, CCTimeType rtt, bool hasBAndAS, BytesPerMicrosecond RAKNET_BB, BytesPerMicrosecond RAKNET_AS, double totalUserDataBytesAcked, bool isContinuousSend, DatagramSequenceNumberType sequenceNumber );
	...
	void OnSendAckGetBAndAS(CCTimeType curTime, bool *hasBAndAS, BytesPerMicrosecond *RAKNET_BB, BytesPerMicrosecond *RAKNET_AS);
